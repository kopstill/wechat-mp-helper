...
public class WXBizMsgCrypt {
     ...
     * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
     */
    public void verifyUrl(String msgSignature, String timeStamp, String nonce, String echoStr)
            throws AesException {
     ...
     * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
     */
    public void verifyUrl(String signature, String timestamp, String nonce)
            throws AesException {
